      ...
      <UContainer>
        ...
        <div class="mt-10 border-t border-default sm:mt-12">
          <NuxtLink
            ...
            :to="work.to"
            target="_blank"
            class="group grid grid-cols-[2.5rem_minmax(0,1fr)_1.5rem] items-center gap-4 border-b border-default py-5 transition-colors duration-300 hover:bg-elevated sm:grid-cols-[4rem_minmax(0,1fr)_17rem_2rem] sm:gap-6 sm:px-2 sm:py-6"
          >
