...
const items = computed(() =>
  (locales.value as Array<{ code: string, name?: string }>)
    ...
    .map(l => ({
      label: t(`langNames.${l.code as 'zh' | 'en' | 'ja' | 'es' | 'pt' | 'fr' | 'de' | 'ru' | 'ar' | 'ko' | 'zh-Hant' | 'vi' | 'id' | 'tr' | 'hi' | 'pl' | 'fa'}`),
      to: switchLocalePath(l.code as 'zh' | 'en' | 'ja' | 'es' | 'pt' | 'fr' | 'de' | 'ru' | 'ar' | 'ko' | 'zh-Hant' | 'vi' | 'id' | 'tr' | 'hi' | 'pl' | 'fa') || undefined,
